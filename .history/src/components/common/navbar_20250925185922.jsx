...
const LanguageSelector = ({ onLanguageChange }) => (
    <div
        className="relative bg-white rounded h-11 w-25 flex items-center cursor-pointer hover:bg-gray-50 transition-colors"
        onClick={onLanguageChange}
    >
        <span className="text-sm font-semibold text-black ml-2">Langue</span>
