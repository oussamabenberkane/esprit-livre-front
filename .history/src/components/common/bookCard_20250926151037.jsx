            ...
            <div className="p-4">
                ...
                <div className="absolute bottom-2 right-2 transition-transform duration-300">
                    <button
                        ...
                        className="w-26 bg-blue-600 text-white py-2 px-4 rounded-lg flex items-center justify-center gap-2 hover:bg-blue-700 transition-colors duration-200"
                    >
                        <ShoppingCart className="w-4 h-4 flex-shrink-0 justify-center" />
