...
const BookCard = ({
    ...
    return (
        <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden group w-64 h-106 relative">
            ...
            <div className="p-4">
                {/* Title */}
                <h3 className="font-semibold text-gray-900 text-md mb-1 line-clamp-2 hover:text-blue-600 transition-colors cursor-pointer">
                    {title}
                </h3>
                ...
                <div className="absolute bottom-0 right-0 transition-transform duration-300">
                    ...
                    >
                        <span className="text-sm font-normal">Ajouter</span>
