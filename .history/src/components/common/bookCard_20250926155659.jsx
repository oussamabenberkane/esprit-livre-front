    ...
    return (
        <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden group w-64 h-106 relative">
            ...
            <div className="p-4">
                ...
                <div className="absolute bottom-[-10] right-0 transition-transform duration-300">
                    <button
                        onClick={handleAddToCartClick}
                        className="w-22 h-10 bg-[#EE0027] text-white content-center justify-center cursor-pointer py-1 px-1 rounded-tl-lg flex flex-col items-center justify-center hover:bg-[#d4183d]"
                    >
