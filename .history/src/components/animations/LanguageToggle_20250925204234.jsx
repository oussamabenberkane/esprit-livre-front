...
const LanguageToggle = ({ onLanguageChange }) => {
    ...
    return (
        ...
        >
            ...
            >
                <motion.img
                    initial={{ opacity: 1, display:  }}
                    animate={{ opacity: 0 }}
                    className="w-4 h-4 text-gray-600" src='assets/icons/french-flag.png' />
                <motion.img
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    className="w-4 h-4 text-gray-600" src='assets/icons/english-flag.png' />
            </motion.div>
        </motion.button>
    );
};
