            ...
            <div className="p-4">
                ...
                <div className="absolute bottom-0 right-0 transition-transform duration-300">
                    <button
                        ...
                        className="w-26 h-full bg-[#EE0027] text-white rounded-tl-lg flex flex-col items-center justify-center gap-1 hover:bg-blue-700 transition-colors duration-200"
                    >
