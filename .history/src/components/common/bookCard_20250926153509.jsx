        ...
        <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden group w-64 h-96 relative">
            ...
            <div className="relative w-48 h-64 overflow-hidden">
                ...
                <button
                    ...
                    className="absolute top-2 right-0 p-2 bg-white/80 backdrop-blur-sm rounded-full hover:bg-white transition-colors duration-200"
                >
                    <Heart
            ...
            <div className="p-4">
                ...
                <div className="absolute bottom-0 right-0 transition-transform duration-300">
                    <button
                        ...
                        className="w-26 bg-[#EE0027] text-white py-1 px-1 rounded-tl-lg  flex items-center justify-center gap-1 hover:bg-blue-700 transition-colors duration-200"
                    >
                        <ShoppingCart className="w-5 h-5 flex-shrink-0" />
                        <span className="text-md font-medium">Ajouter </span>
                    </button>
                </div>
