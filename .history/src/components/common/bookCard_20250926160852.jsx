...
const BookCard = ({
    ...
    return (
        <div className="bg-white rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden group w-70 h-106 relative">
            ...
            <div className="relative w-full h-64 overflow-hidden">
                ...
                <button
                    ...
                    className="absolute top-0 right-0 p-2 bg-white/80 backdrop-blur-sm rounded-full hover:bg-white transition-colors duration-200"
                >
                    <Heart
