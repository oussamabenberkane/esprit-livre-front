...
const BookCard = ({
    ...
    return (
        <div className="bg-white rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden group w-70 h-110 relative">
            ...
            <div className="flex flex-1 w-full h-64 overflow-hidden">
                <img
                    src={coverImage}
                    alt={title}
                    className="absolute w-50 justiy-center h-auto object-cover group-hover:scale-105 transition-transform duration-300"
                />
