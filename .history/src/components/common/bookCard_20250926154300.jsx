    ...
    return (
        <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden group w-64 h-96 relative">
            ...
            <div className="p-4">
                ...
                <div className="absolute bottom-0 right-0 transition-transform duration-800">
                    <button
                        onClick={handleAddToCartClick}
                        className="w-26 h-full bg-[#EE0027] text-white py-1 px-1 rounded-tl-lg flex flex-col items-center justify-center gap-1 hover:bg-blue-700 transition-colors duration-200"
                    >
