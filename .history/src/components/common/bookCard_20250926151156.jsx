    ...
    return (
        <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden group w-64 h-96 relative">
            ...
            <div className="p-4">
                ...
                <div className="absolute bottom-0 right-2 transition-transform duration-300">
                    <button
                        onClick={handleAddToCartClick}
                        className="w-26 bg-blue-600 text-white py-0 px-0 rounded-lg flex items-center justify-center gap-1 hover:bg-blue-700 transition-colors duration-200"
                    >
