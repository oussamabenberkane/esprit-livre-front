...
const BookCard = ({
    ...
    return (
        <div className="bg-white rounded-2xl relative shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden group w-70 h-110 relative">
            {/* Book Cover Container */}
            <div className="absolute justify-center w-full h-64 overflow-hidden">
                <img
                    src={coverImage}
                    alt={title}
                    className="w-60 absolute justicy-center h-full object-cover group-hover:scale-105 transition-transform duration-300"
                />
                ...
                <button
                    ...
                    className="absolute top-1 right-0 p-2 bg-white/80 backdrop-blur-sm rounded-full hover:bg-white transition-colors duration-200"
                >
                    <Heart
            ...
            <div className="p-4">
                ...
                <div className="absolute bottom-0 right-0 transition-transform duration-300">
                    <button
                        ...
                        className="w-20 h-12 bg-[#EE0027] text-white cursor-pointer py-1 px-1 rounded-tl-lg flex flex-col items-center justify-center hover:bg-[#d4183d]"
                    >
