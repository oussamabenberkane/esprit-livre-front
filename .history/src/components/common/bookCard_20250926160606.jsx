...
const BookCard = ({
    ...
    return (
        <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden group w-70 h-106 relative">
            ...
            <div className="relative w-full h-64 overflow-hidden">
                ...
                >
                    <Heart
                        className={`w-6 h-6 transition-colors duration-200 ${favorited ? 'fill-red-500 text-red-500' : 'text-gray-600 hover:text-red-500'
                            }`}
                    />
                </button>
            ...
            <div className="p-4">
                ...
                <div className="absolute bottom-0 right-0 transition-transform duration-300">
                    <button
                        ...
                        className="w-22 h-10 bg-[#EE0027] text-white cursor-pointer py-1 px-1 rounded-tl-lg flex flex-col items-center justify-center hover:bg-[#d4183d]"
                    >
                        <span className="text-sm font-[600]">Ajouter</span>
                        <ShoppingCart className="w-6 h-5 flex-shrink-0" />
                    </button>
                </div>
