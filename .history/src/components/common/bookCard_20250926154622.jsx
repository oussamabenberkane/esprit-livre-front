            ...
            <div className="p-4">
                ...
                <div className="absolute bottom-0 right-0 transition-transform duration-300">
                    <button
                        ...
                        className="w-22 h-12 bg-[#EE0027] text-white py-1 px-1 rounded-tl-lg flex flex-col items-center justify-center hover:bg-blue-700 transition-colors duration-200"
                    >
