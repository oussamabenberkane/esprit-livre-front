...
const CategoryCard = ({
    ...
    return (
        <div className="relative w-[150px] h-[70px] bg-gray-200 rounded-[10px] overflow-hidden leading- cursor-pointer hover:scale-102 transition-transform duration-200">
            {/* Background Image */}
