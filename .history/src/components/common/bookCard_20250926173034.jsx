...
const BookCard = ({
    ...
    return (
        <div className="bg-white rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden group w-60 h-105 relative">
            ...
            <div className="relative  w-full h-68 overflow-hidden flex items-end justify-center">
                ...
                {/* Badge */}
                {badge && (
                    <div className={`absolute top-0 left-0 px-3 py-2 rounded-br-2xl text-[10px] font-semibold ${getBadgeStyles(badge.type)}`}>
                        {badge.text}
                    </div>
                )}
                ...
                >
                    <Heart
                        className={`w-6.5 h-6.5 transition-colors duration-200 ${favorited ? 'fill-red-500 text-red-500' : 'text-gray-600 hover:text-red-500'
                            }`}
                    />
                </button>
            ...
            <div className="p-4">
                ...
                <div className="flex items-center justify-between mb-0">
                    <span className="text-lg font-bold text-gray-900">
                        {price} <span className="text-xs font-bold">DZD</span>
                    </span>
                </div>
                ...
                <div className="absolute bottom-0 right-0 transition-transform duration-300">
                    ...
                    >
                        <span className="text-[10px] font-semibold">Ajouter <br /> au panier</span>
                    </button>
                </div>
